...
Partial Public Class UpdateDetails
    ...
    Public Function GetMCFiles()
        ...
        Try
            ...
            lstrUSER_GESSOUID = "DBFA4B7E-3BCD-1F46-A66D-00212872B1DA"
    ...
    Function GetLog4NetConfigPath() As String
        GetLog4NetConfigPath = "D:\GE GDC Working Folder\sumit2.sharma\StarTeam\MoneyCost\log4net_DLL.config" 'ReadRegistry("SOFTWARE\\FacilitySettings\\MoneyCost\\FilePath", "WEBLog4NetConfig")
    End Function
