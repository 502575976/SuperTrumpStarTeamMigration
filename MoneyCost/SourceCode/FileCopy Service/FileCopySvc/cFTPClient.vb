...
#Region "Public Subs and Functions"
    ...
    Public Function Login() As Boolean
        ...
        Try
            'm_objClientSocket.SetSocketOption(SocketOptionLevel.Socket, SocketOptionName.SendTimeout, 100000)
            'm_objClientSocket.SetSocketOption(SocketOptionLevel.Socket, SocketOptionName.ReceiveTimeout, 100000)

            m_objClientSocket.Connect(ep)
        Catch ex As Exception
            MessageString = m_sReply
            Throw New IOException("Cannot connect to the remote server - " & ex.Message & "  Source: " & ex.Source)
