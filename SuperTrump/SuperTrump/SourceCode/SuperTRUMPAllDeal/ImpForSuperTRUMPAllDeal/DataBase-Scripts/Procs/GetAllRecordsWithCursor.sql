CREATE OR REPLACE procedure GetAllRecordsWithCursor (Creation_date_Check IN DATE default null,AccountScheduleFeed OUT SYS_REFCURSOR,StreamFeed OUT SYS_REFCURSOR,AssetLevelFeed OUT SYS_REFCURSOR,ProductMapping OUT SYS_REFCURSOR,TemplateMapping OUT SYS_REFCURSOR,Depriciation OUT SYS_REFCURSOR)
IS
BEGIN
