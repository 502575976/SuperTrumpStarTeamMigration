...
Public Class SupertrumpService
    ...
    Dim STLogger As log4net.ILog = log4net.LogManager.GetLogger(MethodBase.GetCurrentMethod().DeclaringType)
...
#Region "IClientService"
    ...
    '    Dim lobjSTWebService As New BusinessServices.ISuperTrumpService
    '    Try
    '        Return lobjSTWebService.Ping()
    '    Catch ex As Exception
    '        Return ex.Message()
    '    Finally
    '        lobjSTWebService.Dispose()
    ...
    <SoapDocumentMethod(Binding:="IClientServiceSoapPort"), STAThreadAttribute(), WebMethod()> _
       Public Function Ping() As String
        ...
        Dim lobjSTWebSuperTrumpService = BusinessServices.ISuperTrumpService.Instance
        Dim lobjSTWebClientService = BusinessServices.IClientService.Instance
        Try
        ...
        Catch ex As Exception
            ...
            Return ex.Message
        Finally
            'lobjSTWebClientService.Dispose()
            lobjSTWebClientService = Nothing
            'lobjSTWebSuperTrumpService.Dispose()
    ...
    Public Function ProcessMQMessage(ByVal astrMQMsgInfoXML As String) As String
        ...
        Dim obj = BusinessServices.IClientService.Instance
        Try
    ...
    Public Function ProcessPricingRequest(ByVal astrPricingRequestXML As String) As String
        ...
        Dim lobjSTWebService = BusinessServices.IClientService.Instance
        Try
            If (HttpRuntime.Cache.Get("STObjectByCache") Is Nothing) Then
                lobjSTWebService = BusinessServices.IClientService.Instance
...
#Region "ISuperTrumpService Code Area"
    ...
    Function ConvertPRMToXML(ByVal astrPRMFileListXML As String) As String
        ...
        Dim lobjSTWebService = BusinessServices.ISuperTrumpService.Instance
        Try
