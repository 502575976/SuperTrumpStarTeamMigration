        ...
        Try
            ...
            SyncLock obj
                ...
                For lintCtrLoop = 0 To (lobjFileNameList.Count - 1)
                    ...
                    STLogger.Debug("ProcessId:" & System.Diagnostics.Process.GetCurrentProcess.Id.ToString() & " ThreadId:" & System.AppDomain.CurrentDomain.GetCurrentThreadId.ToString() & " BSSuperTrump.ISuperTrumpService_ConvertPRMToXML(): Calling XMLInOut() method with input - " & lstrSupertrumpQuery)
                    ...
                    If (lobjPRMExceptionXMLDOM.GetElementsByTagName("Exception").Count) > 0 Then
                        ...
                        STLogger.Debug("ProcessId:" & System.Diagnostics.Process.GetCurrentProcess.Id.ToString() & " ThreadId:" & System.AppDomain.CurrentDomain.GetCurrentThreadId.ToString() & " BSSuperTrump.ISuperTrumpService_ConvertPRMToXML(): Exception from STServer : " & lobjPRMExceptionXMLDOM.SelectSingleNode("//Exceptions").OuterXml)
                ...
                STLogger.Debug("ProcessId:" & System.Diagnostics.Process.GetCurrentProcess.Id.ToString() & " ThreadId:" & System.AppDomain.CurrentDomain.GetCurrentThreadId.ToString() & " BSSuperTrump.ISuperTrumpService_ConvertPRMToXML(): Return value : " & lstrPRM2XML)
            ...
            SyncLock obj
                ...
                For liPRMParamsCnt = 0 To lobjPRMInfoXMLDOM.DocumentElement.ChildNodes.Count - 1
                    Try
                        ...
                        STLogger.Debug("ProcessId:" & System.Diagnostics.Process.GetCurrentProcess.Id.ToString() & " ThreadId:" & System.AppDomain.CurrentDomain.GetCurrentThreadId.ToString() & " BSSuperTrump.ISuperTrumpService_GeneratePRMFiles(): Calling XMLInOut() method with input - " & lobjSTQueryXMLDOM.OuterXml)
                        ...
                        If (lobjExeceptionlst.Count) > 0 Then
                            ...
                            STLogger.Debug("ProcessId:" & System.Diagnostics.Process.GetCurrentProcess.Id.ToString() & " ThreadId:" & System.AppDomain.CurrentDomain.GetCurrentThreadId.ToString() & " BSSuperTrump.ISuperTrumpService_GeneratePRMFiles(): Exception from STServer : " & lobjSTResponseXMLDOM.SelectSingleNode("//Exceptions").OuterXml)
                ...
                Next
                STLogger.Debug("ProcessId:" & System.Diagnostics.Process.GetCurrentProcess.Id.ToString() & " ThreadId:" & System.AppDomain.CurrentDomain.GetCurrentThreadId.ToString() & " BSSuperTrump.ISuperTrumpService_GeneratePRMFiles(): Return value: " & lobjReturnPRMLstXMLDOM.OuterXml)
    ...
    Public Function GetAmortizationSchedule(ByVal astrPRMFileListXML As String) As String
        ...
        Try
            ...
            SyncLock obj
                ...
                For liPRMFileLstCnt = 0 To lobjPRMFileListXMLDOM.DocumentElement.ChildNodes.Count - 1
                    Try
                        ...
                        If (lobjPRMInfoXMLDOM.GetElementsByTagName("Exception").Count) > 0 Then
                            ...
                            STLogger.Debug("ProcessId:" & System.Diagnostics.Process.GetCurrentProcess.Id.ToString() & " ThreadId:" & System.AppDomain.CurrentDomain.GetCurrentThreadId.ToString() & " BSSuperTrump.ISuperTrumpService_GetAmortizationSchedule(): Exception from STServer : " & lobjPRMInfoXMLDOM.SelectSingleNode("//Exceptions").OuterXml)
                        End If
                        ...
                        If (lobjSTResponseXMLDOM.GetElementsByTagName("Exception").Count) > 0 Then
                            ...
                            Dim lstrErrComment As String = ""
                            If Not (lobjErrComment Is Nothing) Then lstrErrComment = lobjErrComment.InnerText
                            STLogger.Debug("ProcessId:" & System.Diagnostics.Process.GetCurrentProcess.Id.ToString() & " ThreadId:" & System.AppDomain.CurrentDomain.GetCurrentThreadId.ToString() & " BSSuperTrump.ISuperTrumpService_GetAmortizationSchedule(): Exception from STServer : " & lobjSTResponseXMLDOM.SelectSingleNode("//Exceptions").OuterXml)
                        End If
                ...
                STLogger.Debug("ProcessId:" & System.Diagnostics.Process.GetCurrentProcess.Id.ToString() & " ThreadId:" & System.AppDomain.CurrentDomain.GetCurrentThreadId.ToString() & "  " & System.Reflection.MethodInfo.GetCurrentMethod.Name & "Synclock End here")
            End SyncLock
            STLogger.Debug("ProcessId:" & System.Diagnostics.Process.GetCurrentProcess.Id.ToString() & " ThreadId:" & System.AppDomain.CurrentDomain.GetCurrentThreadId.ToString() & " BSSuperTrump.ISuperTrumpService_GetAmortizationSchedule(): Return value: " & lobjReturnAmortSchedLstXMLDOM.OuterXml)
    ...
    Public Function GetPricingReports(ByVal astrPricingRepInfoXML As String) As String
        ...
        Try
            ...
            SyncLock obj
                ...
                STLogger.Debug("ProcessId:" & System.Diagnostics.Process.GetCurrentProcess.Id.ToString() & " ThreadId:" & System.AppDomain.CurrentDomain.GetCurrentThreadId.ToString() & " BSSuperTrump.ISuperTrumpService_GetPricingReports(): Return value: " & lstrPRICING_REPORT)
    ...
    Public Function GetPRMParams(ByVal astrPRMParamsInfoXML As String) As String
        ...
        Try
            ...
            SyncLock obj
                    ...
                    Try
                        ...
                        With lobjPRMParamsInfoXMLDOM.DocumentElement.ChildNodes(liPRMParamsSpecCnt)
                            ...
                            If Not (lobjPRMFileBinDataElem Is Nothing) Then
                                ...
                                '''''Added By lalit June, 2010
                                lstrXMLInOutInput = "<SuperTRUMP>" & "<Transaction query='true'><TRANSACTIONSTATE>" & lobjPRMFileBinDataElem.InnerXml & "</TRANSACTIONSTATE><Calculate /></Transaction>" & "</SuperTRUMP>"
                                STLogger.Debug("ProcessId:" & System.Diagnostics.Process.GetCurrentProcess.Id.ToString() & " ThreadId:" & System.AppDomain.CurrentDomain.GetCurrentThreadId.ToString() & " BSSuperTrump.ISuperTrumpService_GetPRMParams(): Calling XMLInOut() method with input to get binary trnsaction state - " & lstrSTQuery)
                                lstrReturnXMLInOut = lobjSTApplication.XmlInOut(lstrXMLInOutInput)
                                ...
                                If (lobjPRMInfoXMLDOM.GetElementsByTagName("Exception").Count) > 0 Then
                                    ...
                                    Dim lstrErrComment1 As String = ""
                                    If Not (lobjErrComment1 Is Nothing) Then lstrErrComment1 = lobjErrComment1.InnerText
                                    STLogger.Debug("ProcessId:" & System.Diagnostics.Process.GetCurrentProcess.Id.ToString() & " ThreadId:" & System.AppDomain.CurrentDomain.GetCurrentThreadId.ToString() & " BSSuperTrump.ISuperTrumpService_GetPRMParams(): Exception from STServer : " & lobjPRMInfoXMLDOM.SelectSingleNode("//Exceptions").OuterXml)
                                End If
                                ...
                                STLogger.Debug("ProcessId:" & System.Diagnostics.Process.GetCurrentProcess.Id.ToString() & " ThreadId:" & System.AppDomain.CurrentDomain.GetCurrentThreadId.ToString() & " BSSuperTrump.ISuperTrumpService_GetPRMParams(): Calling XMLInOut() method with input - " & lstrSTQuery)
                                ...
                                If (lobjExeceptionlst.Count) > 0 Then
                                    ...
                                    STLogger.Debug("ProcessId:" & System.Diagnostics.Process.GetCurrentProcess.Id.ToString() & " ThreadId:" & System.AppDomain.CurrentDomain.GetCurrentThreadId.ToString() & " BSSuperTrump.ISuperTrumpService_GetPRMParams(): Exception from STServer : " & lobjSTResponseXMLDOM.SelectSingleNode("//Exceptions").OuterXml)
                ...
                lstrPRMFilePath = GetConfigurationKey("PRMFilePath")                
            End SyncLock            
            STLogger.Debug("ProcessId:" & System.Diagnostics.Process.GetCurrentProcess.Id.ToString() & " ThreadId:" & System.AppDomain.CurrentDomain.GetCurrentThreadId.ToString() & " BSSuperTrump.ISuperTrumpService_GetPRMParams(): Return value: " & lobjReturnPRMParamLstXMLDOM.OuterXml)
            ...
            SyncLock obj
                ...
                For liCnt = 0 To lobjRequestXMLDOM.DocumentElement.ChildNodes.Count - 1
                    Try
                        ...
                        STLogger.Debug("ProcessId:" & System.Diagnostics.Process.GetCurrentProcess.Id.ToString() & " ThreadId:" & System.AppDomain.CurrentDomain.GetCurrentThreadId.ToString() & " BSSuperTrump.ISuperTrumpService_ModifyPRMFiles(): Input XML for the XMLInOut() method: " & lstrSTServerReqXML)
                        ...
                        STLogger.Debug("ProcessId:" & System.Diagnostics.Process.GetCurrentProcess.Id.ToString() & " ThreadId:" & System.AppDomain.CurrentDomain.GetCurrentThreadId.ToString() & " BSSuperTrump.ISuperTrumpService_ModifyPRMFiles(): Response XML for the XMLInOut() method: " & lstrSTServerRespXML)
                        ...
                        If (lobjPRMExceptionXMLDOM.GetElementsByTagName("Exception").Count) > 0 Then
                            ...
                            Dim lstrErrComment1 As String = ""
                            If Not (lobjErrComment1 Is Nothing) Then lstrErrComment1 = lobjErrComment1.InnerText
                            STLogger.Debug("ProcessId:" & System.Diagnostics.Process.GetCurrentProcess.Id.ToString() & " ThreadId:" & System.AppDomain.CurrentDomain.GetCurrentThreadId.ToString() & " BSSuperTrump.ISuperTrumpService_ModifyPRMFiles(): Exception from STServer : " & lobjPRMExceptionXMLDOM.SelectSingleNode("//Exceptions").OuterXml)
                        End If
                        ...
                        If lobjPRMExceptionXMLDOM_Flag = True Then
                            ...
                            STLogger.Debug("ProcessId:" & System.Diagnostics.Process.GetCurrentProcess.Id.ToString() & " ThreadId:" & System.AppDomain.CurrentDomain.GetCurrentThreadId.ToString() & " BSSuperTrump.ISuperTrumpService_ModifyPRMFiles(): Error loading STServer response XML!!! " & lobjPRMExceptionXMLDOM.OuterXml)
                        ...
                        ElseIf (lobjPRMExceptionXMLDOM.GetElementsByTagName("Exception").Count) > 0 Then
                            ...
                            STLogger.Debug("ProcessId:" & System.Diagnostics.Process.GetCurrentProcess.Id.ToString() & " ThreadId:" & System.AppDomain.CurrentDomain.GetCurrentThreadId.ToString() & " BSSuperTrump.ISuperTrumpService_ModifyPRMFiles(): Exception returned from STServer!!! " & lobjPRMExceptionXMLDOM.OuterXml)
                ...
                lbProcessingPRMFile = False
                STLogger.Debug("ProcessId:" & System.Diagnostics.Process.GetCurrentProcess.Id.ToString() & " ThreadId:" & System.AppDomain.CurrentDomain.GetCurrentThreadId.ToString() & " BSSuperTrump.ISuperTrumpService_ModifyPRMFiles(): Output:" & lobjResponseXMLDOM.OuterXml)
    ...
    Private Function GeneratePRMFilesForPmtStructure(ByVal astrPRMInfoXML As String, ByVal astrMethodType As eSolveMethod) As String
        ...
        Try
            ...
            SyncLock obj
                ...
                Try
                    ...
                    For liPRMParamsCnt = 0 To lobjPRMInfoXMLDOM.DocumentElement.ChildNodes.Count - 1
                        ...
                        If (lobjExeceptionlst.Count) > 0 Then
                            ...
                            STLogger.Debug("ProcessId:" & System.Diagnostics.Process.GetCurrentProcess.Id.ToString() & " ThreadId:" & System.AppDomain.CurrentDomain.GetCurrentThreadId.ToString() & " BSSuperTrump.ISuperTrumpService_GeneratePRMFilesForPmtStructure(): Exception from STServer : " & lobjSTResponseXMLDOM.SelectSingleNode("//Exceptions").OuterXml)
                        End If
                                                'Add it to the Return XML    
                        lobjBinarylst = lobjSTResponseXMLDOM.GetElementsByTagName("Transaction")
                        lvPRMFileData = lobjBinarylst.Item(0).SelectSingleNode("TRANSACTIONSTATE")
                ...
                'For Each set of PRM Parameters in the Input XML            
                lstrPRMFilePath = GetConfigurationKey("PRMFilePath")                                
                STLogger.Debug("ProcessId:" & System.Diagnostics.Process.GetCurrentProcess.Id.ToString() & " ThreadId:" & System.AppDomain.CurrentDomain.GetCurrentThreadId.ToString() & " BSSuperTrump.ISuperTrumpService_GeneratePRMFilesForPmtStructure(): Return value: " & lobjReturnPRMLstXMLDOM.OuterXml)
