...
Dim SoapServer
If Not Application("BSCEFSuperTrumpInitialized") Then
  Application.Lock
  If Not Application("BSCEFSuperTrumpInitialized") Then
    Dim WSDLFilePath
    Dim WSMLFilePath
    WSDLFilePath = Server.MapPath("BSCEFSuperTrump.wsdl")
    WSMLFilePath = Server.MapPath("BSCEFSuperTrump.wsml")
    ...
    Set Application("BSCEFSuperTrumpServer") = SoapServer
    Application("BSCEFSuperTrumpInitialized") = True
  End If
  Application.UnLock
End If
Set SoapServer = Application("BSCEFSuperTrumpServer")
