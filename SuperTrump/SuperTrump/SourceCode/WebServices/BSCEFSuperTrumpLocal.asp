...
Dim SoapServer
If Not Application("BSCEFSuperTrumpLocalInitialized") Then
  Application.Lock
  If Not Application("BSCEFSuperTrumpLocalInitialized") Then
    Dim WSDLFilePath
    Dim WSMLFilePath
    WSDLFilePath = Server.MapPath("BSCEFSuperTrumpLocal.wsdl")
    WSMLFilePath = Server.MapPath("BSCEFSuperTrumpLocal.wsml")
    ...
    Set Application("BSCEFSuperTrumpLocalServer") = SoapServer
    Application("BSCEFSuperTrumpLocalInitialized") = True
  End If
  Application.UnLock
End If
Set SoapServer = Application("BSCEFSuperTrumpLocalServer")
